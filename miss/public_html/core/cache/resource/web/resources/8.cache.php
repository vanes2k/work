<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1594640357,
    'editedby' => 1,
    'editedon' => 1594642040,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1594640340,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<head>
    ...
    <link rel="stylesheet" href="http://misschaplin.ru//tmp/style.css">  <script type="text/javascript" >
...
<noscript><div><img src="https://mc.yandex.ru/watch/65527327" style="position:absolute; left:-9999px;" alt="" /></div></noscript> 
<meta name="yandex-verification" content="78ee2068dcde827d" />
    <meta name="description" 
content="">
<base href="http://misschaplin.ru/">
    <title>Новости</title>
</head>
...
<body>
        ...
        <div class="navbar-brand">
            <a class="navbar-item" href="/">
                <img src="http://misschaplin.ru//tmp/logo.png" >
            </a>
  <a onclick="ym(65527327,\'reachGoal\',\'tel\') return true;" href="tel:+7 (909) 665-62-70" class="navbar-item is-hidden-desktop"><span class="button is-small is-danger">
                    +7 (909) 665-62-70
                </span></a>
                 <span class="navbar-item is-hidden-desktop">
                <button class="button is-danger is-small" onclick="openRecall();">Заказать звонок</button>
                </span>
        ...
        <div class="navbar-menu">
            ...
            <div class="navbar-start">
                <a href="/"  class="navbar-item has-text-weight-bold is-size-4">Главная</a><div class="navbar-item has-dropdown has-text-weight-bold is-size-4 is-hoverable">
                <a href="услуги/"  class="navbar-link hoverbg">Услуги</a>
                <div class="navbar-dropdown">
                    <a href="маникюр.html"  class="navbar-item hoverbg">Маникюр Педикюр</a><a href="стрижка/"  class="navbar-item hoverbg">Стрижка и окрашивание волос</a><a href="укладка-волос.html"  class="navbar-item hoverbg">Укладка волос</a><a href="косметология.html"  class="navbar-item hoverbg">Косметология</a>
                </div>
            </div><a href="новости.html"  class="navbar-item has-text-weight-bold is-size-4">Новости</a><a href="контакты.html"  class="navbar-item has-text-weight-bold is-size-4">Контакты</a>
               <!-- <a href="/" class="navbar-item has-text-weight-bold is-size-4">Главная</a>
                <a href="?id=2" class="navbar-item has-text-weight-bold is-size-4">Услуги и цены</a>
                <a href="?id=3" class="navbar-item has-text-weight-bold is-size-4">Контакты</a>-->
            ...
            <div class="navbar-end">
                ...
                <a href="https://vk.com/misschaplin1" class="navbar-item is-size-4 has-text-danger"><i class="fab fa-vk"></i></a>
                <a href="[[++ins_link]]" class="is-size-4 navbar-item has-text-danger"><i class="fab fa-instagram"></i></a>
                <a onclick="ym(65527327,\'reachGoal\',\'tel\') return true;" href="tel:+7 (903) 005-30-07" class="navbar-item "><span class="button is-danger">
                    +7 (903) 005-30-07
                </span></a>
                 <a onclick="ym(65527327,\'reachGoal\',\'tel\') return true;" href="tel:+7 (909) 665-62-70" class="navbar-item "><span class="button is-danger">
                    +7 (909) 665-62-70
                </span></a>
            </div>
        </div>
    </nav>
    <a href="/"  class="logo-image"><img src="http://misschaplin.ru//tmp/logo.png" alt=""></a>
    <div class="modal" id="reCall">
    <div class="modal-background"></div>
    <div class="modal-content">
        <div class="box">
            <form action="http://misschaplin.ru/?id=11" class="form" id="reCallForm" method="POST">
                <div class="field" id="forNameRecall">
                    <label class="label">Ваше имя<span class="has-text-danger">&nbsp;*</span></label>
                    <div class="control">
                        <input class="input" name="name" type="text" placeholder="Введите имя" autofocus required>
                    </div>
                ...
                <div class="field" id="forTelRecall">
                    <label class="label">Телефон<span class="has-text-danger">&nbsp;*</span></label>
                    <div class="control">
                        <input class="input required" name="tel" type="tel" placeholder="Введите телефон" autofocus
                            required>
                    </div>
                    <p class="help is-danger">
                ...
                <div class="field">
                    <label class="label">Хотите задать вопрос?</label>
                    <div class="control">
                        <textarea class="textarea is-primary" name="message"
                            placeholder="Введите ваш вопрос"></textarea>
                    </div>
                </div>
                <script src=\'https://www.google.com/recaptcha/api.js\'></script>
                <div style="margin: 0 auto;display: table" class="g-recaptcha" data-sitekey="6LcpytMUAAAAAGq4ExTsPYvOg1S9LcgTS3X-_2To"></div>
                <input type="submit" onclick="reCallInit();return false;" value="Перезвоните мне!"
                    class="button is-warning is-fullwidth">
                <br>
              <p class="has-text-grey is-size-7 has-text-centered">
                    «Нажимая на кнопку, вы даёте согласие на обработку своих <a href="политика-в-отношении-обработки-персональных-данных.html"
                        class="has-text-link">персональных данных</a>»
                </p>
            </form>
            <h1 id="recallInfo" class="has-text-centered"></h1>
        </div>
    </div>
    <button class="modal-close is-large" onclick="closeRecall()" aria-label="close"></button>
</div>
    <div class="nice-block mt-6">
        <h2 class="title has-text-black-bis">
            Новости
        </h2>
    </div>
    ...
    <div class="column  is-5 mx-1 box" >
        <time class="is-size-7 has-text-link">08/07/2020 15:01</time>
        <div class="has-text-black-bis content">
        
        <div class="width:100%">
        <img style="display:block; margin:0 auto;" src="https://sun3-12.userapi.com/jNPpSC8A7VXJOShqXRS0KGhEZpAFumtzDD23og/otC_p9zQ7qo.jpg">
        </div>
        
        Морские мотивы - это то, чего не хватает нам всем 🌊 <br />
В студии Miss Chaplin вы точно получите заряд позитивного настроения и летнего тепла ☀☀☀<br />
<br />
🕙Мы работаем с 10:00-21:00 <br />
📞 +7 909 665-62-70 <br />
📍Г. Пушкино, ул. Тургенева, 13 <br />
 <br />
http://misschaplin.ru/
        </div>
    </div>
    ...
    <div class="column  is-5 mx-1 box" >
        <time class="is-size-7 has-text-link">08/07/2020 14:58</time>
        <div class="has-text-black-bis content">
        
        <div class="width:100%">
        <img style="display:block; margin:0 auto;" src="https://sun3-12.userapi.com/rr-w-6PPXIA_v5RjdilA0ihUTn4cwWErnYz0zA/UBx130cucpk.jpg">
        </div>
        
        Маникюр нашей победительницы @milkyyyy__wayyyy 🥳🥳🥳 <br />
Не забывайте, что у нас всегда много акций, активностей и конкурсов 🎁<br />
<br />
🕙Мы работаем с 10:00-21:00 <br />
📞 +7 909 665-62-70 <br />
📍Г. Пушкино, ул. Тургенева, 13 <br />
...
http://misschaplin.ru/
    ...
    <div class="column  is-5 mx-1 box" >
        <time class="is-size-7 has-text-link">08/07/2020 14:57</time>
        <div class="has-text-black-bis content">
        
        <div class="width:100%">
        <img style="display:block; margin:0 auto;" src="https://sun3-10.userapi.com/8-OR5tW0yZDPLuh2LiFoNN3iEUREpy_SyDH4OA/5_XgSFrbF2A.jpg">
        </div>
        
        С таким дизайном вы точно не останетесь без внимания 🤩🤩🤩 у нас работают не мастера , а настоящие феи ногтевой сервиса 🔥<br />
<br />
🕙Мы работаем с 10:00-21:00 <br />
📞 +7 909 665-62-70 <br />
📍Г. Пушкино, ул. Тургенева, 13 <br />
...
http://misschaplin.ru/
    ...
    <div class="column  is-5 mx-1 box" >
        <time class="is-size-7 has-text-link">08/07/2020 14:55</time>
        <div class="has-text-black-bis content">
        
        <div class="width:100%">
        <img style="display:block; margin:0 auto;" src="https://sun3-13.userapi.com/fkSRBAIEsx8eho1NdhrCffNU_CLwUjXBWy-pbA/_hWt6KtEtTw.jpg">
        </div>
        
        За идеальными ноготками ждём всех к нам с 10:00 до 21:00 каждый день<br />
<br />
🕙Мы работаем с 10:00-21:00 <br />
📞 +7 909 665-62-70 <br />
📍Г. Пушкино, ул. Тургенева, 13 <br />
...
http://misschaplin.ru/
    ...
    <div class="column  is-5 mx-1 box" >
        <time class="is-size-7 has-text-link">07/24/2020 17:42</time>
        <div class="has-text-black-bis content">
        
        <div class="width:100%">
        <img style="display:block; margin:0 auto;" src="https://sun3-13.userapi.com/jVutEGSIbPxotA15g8gF3Ez6nN57qmWdnejL1w/0t_p3WDjtWY.jpg">
        </div>
        
        Морские мотивы актуальны как никогда!<br />
<br />
🕙Мы работаем с 10:00-21:00 <br />
📞 +7 909 665-62-70 <br />
📍Г. Пушкино, ул. Тургенева, 13 <br />
...
http://misschaplin.ru/
    ...
    <div class="column  is-5 mx-1 box" >
        <time class="is-size-7 has-text-link">07/24/2020 17:41</time>
        <div class="has-text-black-bis content">
        
        <div class="width:100%">
        <img style="display:block; margin:0 auto;" src="https://sun3-13.userapi.com/F-rZjOeWNd-xcQgBzs1j31hvdwK12WjdsQdncw/9R61WeVhEmA.jpg">
        </div>
        
        Нереальной красоты работа нашего мастера Ольги😍😍😍<br />
<br />
🕙Мы работаем с 10:00-21:00 <br />
📞 +7 909 665-62-70 <br />
📍Г. Пушкино, ул. Тургенева, 13 <br />
...
http://misschaplin.ru/
    ...
    <div class="column  is-5 mx-1 box" >
        <time class="is-size-7 has-text-link">07/24/2020 17:40</time>
        <div class="has-text-black-bis content">
        
        <div class="width:100%">
        <img style="display:block; margin:0 auto;" src="https://sun3-12.userapi.com/rdz9Eu9ls3Jw181GpDkGKRBzuQjebQiQ1YLuAw/mqP4PlP8GSc.jpg">
        </div>
        
        Прекрасная работа мастера Татьяны🔥 <br />
Рисунок нарисован вручную 🍑🍑🍑 <br />
🕙Мы работаем с 10:00-21:00 <br />
📞 +7 909 665-62-70 <br />
📍Г. Пушкино, ул. Тургенева, 13<br />
<br />
http://misschaplin.ru/
    ...
    <div class="column  is-5 mx-1 box" >
        <time class="is-size-7 has-text-link">07/15/2020 16:45</time>
        <div class="has-text-black-bis content">
        
        <div class="width:100%">
        <img style="display:block; margin:0 auto;" src="https://sun3-13.userapi.com/6SgSrA0hygTYckOLVGP3vdsOEye01NVLVMKTqg/BMmOX60uLSA.jpg">
        </div>
        
        Девочки, самое время делать педикюр и доставить ваши самые любимые туфли или босоножки! <br />
Сейчас это особенно выгодно сделать у нас, ведь до 20 июля у нас постоянные скидки на всё в честь нашего дня рождения! 🎁🎁🎁Актуальные смотри в сторис✨ <br />
<br />
🕙Мы работаем с 10:00-21:00 <br />
📞 +7 909 665-62-70<br />
<br />
http://misschaplin.ru/
    ...
    <div class="column  is-5 mx-1 box" >
        <time class="is-size-7 has-text-link">07/15/2020 16:43</time>
        <div class="has-text-black-bis content">
        
        <div class="width:100%">
        <img style="display:block; margin:0 auto;" src="https://sun3-10.userapi.com/8huBoxopOeKgzZB1_y1-2QFjoT5pdy6aGt81PA/wRI_bzH5nGI.jpg">
        </div>
        
        Фильмы о моде 🎞 <br />
✨Нараспашку <br />
✨Секреты Лагерфельда <br />
✨Завтрак у Тиффани <br />
✨Джиа <br />
✨Марк Джейкобс и Луи Виттон <br />
✨Верушка: жизнь перед камерой <br />
✨Кристиан Диор: человек-легенда <br />
✨Энни Лейбовиц: через объектив фотоаппарата, <br />
✨Дьявол носит Прада <br />
<br />
🕙Мы работаем с 10:00-21:00 <br />
📞 +7 909 665-62-70 <br />
📍Г. Пушкино, ул. Тургенева, 13<br />
...
http://misschaplin.ru/
    ...
    <div class="column  is-5 mx-1 box" >
        <time class="is-size-7 has-text-link">07/13/2020 16:21</time>
        <div class="has-text-black-bis content">
        
        <div class="width:100%">
        <img style="display:block; margin:0 auto;" src="https://sun3-11.userapi.com/F7DU6YwMR3Ubf9Dn0EOf_v9x8bE9pEaREhrErw/yZx6AiwBUow.jpg">
        </div>
        
        Красота в розовых оттенках от нашего мастера🌸💅🏻 <br />
<br />
🕙Мы работаем с 10:00-21:00 <br />
📞 +7 909 665-62-70 <br />
📍Г. Пушкино, ул. Тургенева, 13<br />
     ...
     <section class="hero is-black">
        <div class="hero-body">
            <div class="columns">
                ...
                <ul>
                    <li><a class="has-text-white" href="косметология.html">Косметология</a></li>
<li><a class="has-text-white" href="укладка-волос.html">Укладка волос</a></li>
<li><a class="has-text-white" href="маникюр.html">Маникюр Педикюр</a></li>
<li><a class="has-text-white" href="стрижка/">Стрижка и окрашивание волос</a></li>
                </ul>
                </div>
                ...
                <li><a href="https://vk.com/misschaplin1" class=" has-text-white">VK</a></li>
                <li> <a href="[[++ins_link]]" class="has-text-white">Instagram</a></li>
        
                 <li><a href="tel:+7 (903) 005-30-07" class="has-text-white"> +7 (903) 005-30-07 </a></li>
                   <li><a href="tel:+7 (909) 665-62-70" class="has-text-white"> +7 (909) 665-62-70 </a></li>
                </ul>
            </div>
            </div>
            <style>
            ...
            <a class="copy is-size-7" href="http://westdigitalart.ru">
               Разработано маркетинговым агентством <img src="http://westdigitalart.ru/tpl/img/logo1.png" style="max-width: 32px"> &copy; 2020
            </a>
        </div>
    </section>
     <script type="text/javascript" src="https://w263702.yclients.com/widgetJS" charset="UTF-8"></script>
</body>
<script src="http://misschaplin.ru//tmp/script.js"></script>
...
<base href="http://misschaplin.ru/">',
    '[[pdoMenu?
            ...
            &tpl = `@INLINE <a href="[[+link]]" [[+attributes]] class="navbar-item has-text-weight-bold is-size-4">[[+menutitle]][[+wrapper]]</a>`
            &tplParentRow = `@INLINE <div class="navbar-item has-dropdown has-text-weight-bold is-size-4 is-hoverable">
                <a href="[[+link]]" [[+attributes]] class="navbar-link hoverbg">[[+menutitle]]</a>
                <div class="navbar-dropdown">
                    [[+wrapper]]
                </div>
            </div>`
            &tplInnerRow = `@INLINE <a href="[[+link]]" [[+attributes]] class="navbar-item hoverbg">[[+menutitle]]</a>`
    ...
    '[[$menu]]' => '    <nav class="navbar is-fixed-top is-dark" role="navigation" aria-label="main navigation">
        <div class="navbar-brand">
            <a class="navbar-item" href="/">
                <img src="http://misschaplin.ru//tmp/logo.png" >
            </a>
...
http://misschaplin.ru/
    ...
    '[[pdoResources?
                    ...
                    &useWeblinkUrl=`1`
                    &tpl=`@INLINE
                    <li><a class="has-text-white" href="[[+link]]">[[+pagetitle]]</a></li>
                    `
                    ]]' => '<li><a class="has-text-white" href="косметология.html">Косметология</a></li>
<li><a class="has-text-white" href="укладка-волос.html">Укладка волос</a></li>
<li><a class="has-text-white" href="маникюр.html">Маникюр Педикюр</a></li>
<li><a class="has-text-white" href="стрижка/">Стрижка и окрашивание волос</a></li>',
    '[[$footer]]' => ' <section class="hero is-black">
        <div class="hero-body">
            <div class="columns">
                <div class="column">
                 <p class="has-text-grey is-size-5">
...
<base href="[[++site_url]]">',
      ...
      array (
        ...
        array (
          ...
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '    <nav class="navbar is-fixed-top is-dark" role="navigation" aria-label="main navigation">
        <div class="navbar-brand">
            <a class="navbar-item" href="/">
                <img src="[[++site_url]]/tmp/logo.png" >
            </a>
  <a onclick="ym(65527327,\'reachGoal\',\'tel\') return true;" href="tel:[[++tel2]]" class="navbar-item is-hidden-desktop"><span class="button is-small is-danger">
                    [[++tel2]]
                </span></a>
                 <span class="navbar-item is-hidden-desktop">
                <button class="button is-danger is-small" onclick="openRecall();">Заказать звонок</button>
        ...
        <div class="navbar-menu">
            ...
            <div class="navbar-end">
                ...
                <a href="[[++vk_link]]" class="navbar-item is-size-4 has-text-danger"><i class="fab fa-vk"></i></a>
                <a href="[[++ins_link]]" class="is-size-4 navbar-item has-text-danger"><i class="fab fa-instagram"></i></a>
                <a onclick="ym(65527327,\'reachGoal\',\'tel\') return true;" href="tel:[[++tel]]" class="navbar-item "><span class="button is-danger">
                    [[++tel]]
                </span></a>
                 <a onclick="ym(65527327,\'reachGoal\',\'tel\') return true;" href="tel:[[++tel2]]" class="navbar-item "><span class="button is-danger">
                    [[++tel2]]
                </span></a>
            </div>
        </div>
    </nav>
    <a href="/"  class="logo-image"><img src="[[++site_url]]/tmp/logo.png" alt=""></a>
    <div class="modal" id="reCall">
    <div class="modal-background"></div>
    <div class="modal-content">
        <div class="box">
            <form action="[[++site_url]]?id=11" class="form" id="reCallForm" method="POST">
                <div class="field" id="forNameRecall">
                    <label class="label">Ваше имя<span class="has-text-danger">&nbsp;*</span></label>
                    <div class="control">
                        <input class="input" name="name" type="text" placeholder="Введите имя" autofocus required>
                ...
                <br>
              <p class="has-text-grey is-size-7 has-text-centered">
                    «Нажимая на кнопку, вы даёте согласие на обработку своих <a href="[[~12]]"
                        class="has-text-link">персональных данных</a>»
                </p>
            </form>
            <h1 id="recallInfo" class="has-text-centered"></h1>
    ...
    <button class="modal-close is-large" onclick="closeRecall()" aria-label="close"></button>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '    <nav class="navbar is-fixed-top is-dark" role="navigation" aria-label="main navigation">
        <div class="navbar-brand">
            <a class="navbar-item" href="/">
                <img src="[[++site_url]]/tmp/logo.png" >
            </a>
    ...
    <button class="modal-close is-large" onclick="closeRecall()" aria-label="close"></button>
      ...
      array (
        ...
        array (
          ...
          'category' => 0,
          'cache_type' => 0,
          'snippet' => ' <section class="hero is-black">
        <div class="hero-body">
            <div class="columns">
                <div class="column">
                 <p class="has-text-grey is-size-5">
                ...
                <li><a href="[[++vk_link]]" class=" has-text-white">VK</a></li>
                <li> <a href="[[++ins_link]]" class="has-text-white">Instagram</a></li>
        
                 <li><a href="tel:[[++tel]]" class="has-text-white"> [[++tel]] </a></li>
                   <li><a href="tel:[[++tel2]]" class="has-text-white"> [[++tel2]] </a></li>
                </ul>
            </div>
            </div>
            <style>
     ...
     <script type="text/javascript" src="https://w263702.yclients.com/widgetJS" charset="UTF-8"></script>',
          ...
          'static' => false,
          'static_file' => '',
          'content' => ' <section class="hero is-black">
        <div class="hero-body">
            <div class="columns">
                <div class="column">
                 <p class="has-text-grey is-size-5">
